...
$(document).ready(function () {
        console.log('se inicio el navbar');
    ...
    var clMobileMenu = function() {
        ...
        menuToggle.on('click', function(e) {
            console.log('click en menuToggle');
            var $this = $(this);
        ...
        closeNavWrap.on('click', function(e) {
            console.log('click en closeNavWrap');
...
function initPlugins(){
    $(document).ready(function () {
        ...
        * ------------------------------------------------------ */
        ...
        function ssInit() {
            // console.log('se inicio los plugins');
